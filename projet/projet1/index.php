...
<html lang="fr">
    ...
    <a href="../portfolio-details-projet-1.html"><img style="background-color: white; border-radius: 10%; padding-right:3px" src="assets/img/retour.png" alt="retour au portfolio" width="50px"></a>
